...
w = open("../../httpd/html/assessment/#{ARGV[0]}#{ARGV[1]}/result/result_top.php","w")
w.print("
...
<html lang=\"ja\">
	<head>
		...
		<title>                                                         
                #{ARGV[0]}年度#{period} 授業評価アンケート                                
                </title>
	</head>
	<body>
		<h1 id=\"title\">#{ARGV[0]}年度 #{period} 授業評価アンケート</h1>
...
?>
		...
		<hr>
		<p>#{ARGV[0]}年度情報工学実験3 調査と解析(R)班<br><a href=\"mailto:r-inquiry@ms.ie.u-ryukyu.ac.jp?subject=#{ARGV[0]}年度#{period}授業評価アンケートについて\">r-inquiry@ms.ie.u-ryukyu.ac.jp</a></p>
